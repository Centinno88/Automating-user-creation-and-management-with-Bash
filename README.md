...
## Usage:
- Clone the `create_users.sh` script from this [repository](https://github.com/Centinno88/Automating-user-creation-and-management-with-Bash/edit/main/README.md) to your **ubuntu server**,
