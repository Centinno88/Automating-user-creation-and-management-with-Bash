...
## Usage:
- Clone the `create_users.sh` script from this [repository](https://github.com/Centinno88/Automating-user-creation-and-management-with-Bash/tree/main) to your **ubuntu server**,
